...
inputTexto.setCustomMessage = mensaje => {
    // console.log('mensaje recibido:', mensaje);
    let inputGroup = inputTexto.closest('.input-group');
    inputGroup.querySelector('.detail').textContent = mensaje;
    // if (mensaje) {
    //     inputGroup.classList.add('error');
    // } else {
    //     inputGroup.classList.remove('error');
    // }
    inputGroup.classList.toggle('error', mensaje);
};
...
function validateInput(value) {
    ...
    // inputTexto.setCustomValidity(mensaje);
    inputTexto.setCustomMessage(mensaje);
...
inputTexto.addEventListener('input', e => {
    validateInput(inputTexto.value);
